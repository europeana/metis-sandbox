...
//        .language(IT)
//        .country(ITALY)
//        .harvestingParametricDto(new FileHarvestDTO("fileName", "fileType", new byte[0], xsltFile.getBytes()))
...
//        .language(IT)
//        .country(ITALY)
//        .harvestingParametricDto(new HttpHarvestDTO("http://url-to-test.com"))
//        .transformedToEdmExternal(false)
//        .build();
//
//    when(datasetService.getDatasetInfo("1")).thenReturn(mock);
...
//        .language(IT)
//        .country(ITALY)
//        .harvestingParametricDto(new OAIPmhHarvestDTO("http://url-to-test.com", "setSpec", "metadataFormat"))
//        .transformedToEdmExternal(false)
//        .build();
//
//    when(datasetService.getDatasetInfo("1")).thenReturn(mock);
