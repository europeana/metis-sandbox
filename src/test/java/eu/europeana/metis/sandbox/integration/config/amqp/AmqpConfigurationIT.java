...
import eu.europeana.metis.sandbox.config.TruststoreConfig;
...
@SpringBootTest(classes = {AmqpConfiguration.class, RecordMessageConverter.class, RabbitAutoConfiguration.class, TruststoreConfig.class})
