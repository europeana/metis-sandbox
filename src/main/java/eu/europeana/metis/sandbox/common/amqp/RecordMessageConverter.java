...
class RecordMessageConverter implements MessageConverter {
  ...
  public Message toMessage(Object object, MessageProperties messageProperties) {
    if (!(object instanceof RecordProcessEvent) && !(object instanceof HarvestOaiPmhEvent)) {
...
//    }
  ...
  public Object fromMessage(Message message) {
    ...
    if (message.getMessageProperties().getHeader(OAI_RECORD_ID) != null &&
        !message.getMessageProperties().getHeader(OAI_RECORD_ID).equals("")) {
...
//      logger.info("fromMessage method: oaiRecordID {} datasetID {}", oaiRecordId, datasetId);
      return new HarvestOaiPmhEvent(Status.BUSY, Step.HARVEST_OAI_PMH, url, setspec, metadataformat,
          oaiRecordId, datasetId);
