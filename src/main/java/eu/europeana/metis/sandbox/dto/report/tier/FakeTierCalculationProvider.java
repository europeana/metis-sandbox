...
public class FakeTierCalculationProvider {
  ...
  public static RecordTierCalculationDto getFakeObject() {
    ...
    recordTierCalculationSummary.setContentTier(String.valueOf(MediaTier.T4.getLevel()));
    recordTierCalculationSummary.setMetadataTier("C");
    ...
    languageBreakdown.setMetadataTier("C");
    ...
    enablingElements.setMetadataTier("C");
    ...
    contextualClasses.setMetadataTier("C");
